...
<template>
  <div class="main" :class="{'main-hide-text': shrink}">
    ...
    <div class="main-header-con" :style="{paddingLeft: shrink?'60px':'220px'}">
      <!-- 上方菜单背景颜色  #FFFACD -->
      <div class="main-header" style="background:#00008b">
        <!-- 收缩按钮 -->
        ...
        <div class="header-middle-con">
          ...
          <div class="main-nav-menu" v-if="navType==1||navType==2">
            <Menu mode="horizontal" :active-name="currNav" @on-select="selectNav">
              <!-- 顶部菜单 -->
              <MenuItem v-for="(item, i) in navList.slice(0, sliceNum)" :key="i" :name="item.name" style="background:#00008b">
            ...
            <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
              <Dropdown transfer trigger="hover" @on-click="handleClickUserDropdown">
                <a>
                  ...
                  <Avatar :src="avatarPath" style="background: #082567;margin-left: 10px;"></Avatar>
                </a>
                <DropdownMenu slot="list">
      ...
      <div class="tags-con" style="background:#082567">
