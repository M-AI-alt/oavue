                ...
                <ul class="slides">
                    <li class="background1">
                        <div class="text center">
                            <h1 class="heading center white margin-bottom-small flex-animation">基于Vue和Springboot的<br>人力资源管理系统</h1>
                            <p class="heading white center margin-bottom flex-animation">物联网181 宁飞</p>
                    ...
                    <li class="background2">
                        <div class="text center">
                            <h1 class="heading center white margin-bottom-small flex-animation no-opacity">基于Vue和Springboot的<br>人力资源管理系统</h1>
                            <p class="heading white center margin-bottom flex-animation no-opacity">物联网181 宁飞</p>
                            <p class="heading white center margin-bottom flex-animation">本次登录地点:{{city}}</p>
